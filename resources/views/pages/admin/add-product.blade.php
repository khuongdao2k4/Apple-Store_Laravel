...
<div class="page-hdr d-flex justify-content-between align-items-start">
    <div>
        ...
        <div class="breadcrumb">
            ...
            <a href="{{ route('admin.products') }}">Sản phẩm</a><span>›</span> Thêm mới
        </div>
    </div>
</div>
            ...
            <div class="form-section">
                <div class="form-section-hdr">
                    ...
                    <div>
                        ...
                        <div class="sec-desc">Tên sản phẩm và phân loại nhóm</div>
                    </div>
                </div>
            ...
            <div class="form-section">
                <div class="form-section-hdr">
                    ...
                    <div style="flex:1">
                        ...
                        <div class="sec-desc">Thêm dung lượng, chip, hoặc các tùy chọn khác</div>
                    </div>
                ...
                <div class="form-section-body" style="padding:0 20px">
                    <div class="opts-table-wrap">
                        ...
                        <div id="no-options-message" class="text-center py-5 text-muted" style="font-size: 13px;">
                            <span class="material-icons-round d-block mb-2" style="font-size: 32px; opacity: 0.3">settings_suggest</span>
                            Chưa có tùy chọn nào. Bấm "Thêm tùy chọn" để bắt đầu.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-section-body">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="series_image" id="series_image_input" class="f-input" placeholder="https://..." required>
            ...
            <div class="form-section">
                <div class="form-section-hdr">
                    ...
                    <div style="flex:1">
                        ...
                        <div class="sec-desc">Chọn các phiên bản màu</div>
                    </div>
                ...
                <div class="form-section-body">
                    <input type="hidden" name="colors" id="colors_hidden_input" value="" required>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    createColorPicker('#ffffff'); // Initial color
