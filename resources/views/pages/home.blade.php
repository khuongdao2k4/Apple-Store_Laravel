...
<main class="main" role="main">
        ...
        <div id="top-module-container" class="container-fluid position-relative overflow-hidden">
            <video src="{{ asset('assets/img/large.mp4') }}" width="100%" autoplay loop muted class="video-large object-fit-cover"
                style="height: 100vh;">
        ...
        <div id="center-module-container" class="container-fluid py-5" style="margin-top:50px">
            <div id="top-content-module" class="row bg-body-tertiary text-center">
                ...
                <div class="col-12 mt-4">
                    <img src="{{ asset('assets/img/hero_iphone_16e_endframe__enpjcl8w7fyq_largetall.png') }}" alt="iPhone 16e"
                        class="img-fluid">
                </div>
        ...
        <div id="body-center-module-container" class="container-fluid" style="margin-top:20px">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="product-image-container" style="margin-bottom:10px">
                            <img src="{{ asset('assets/img/hero_iphone16pro_avail__fnf0f9x70jiy_largetall.jpg') }}"
                    ...
                    <div class="col-md-12">
                        <div class="product-image-container">
                            <img src="{{ asset('assets/img/hero_iphone16_avail__euwzls69btea_largetall.jpg') }}" class="img-fluid"
                                alt="iPhone 16">
            ...
            <section class="product-section mb-1">
                <div class="row gx-1">
                    <div class="col-md-6">
                        <div class="product-image-container">
                            <img src="{{ asset('assets/img/promo_apple_watch_series_10_avail_lte__c70y29goir42_large.jpg') }}"
                    ...
                    <div class="col-md-6">
                        <div class="product-image-container">
                            <img src="{{ asset('assets/img/promo_ipadpro_avail__s271j89g8kii_large.jpg') }}" class="img-fluid"
                                alt="iPad Pro">
                            <div class="product-description">
            ...
            <section class="product-section mb-1">
                <div class="row gx-1">
                    <div class="col-md-6">
                        <div class="product-image-container">
                            <img src="{{ asset('assets/img/promo_macbook_air_m3__e43jegok3wuq_large.jpg') }}" class="img-fluid"
                                alt="MacBook Air">
                            <div class="product-description">
                    ...
                    <div class="col-md-6">
                        <div class="product-image-container">
                            <img src="{{ asset('assets/img/promo_macbookpro_announce__gdf98j6tj2ie_large.jpg') }}" class="img-fluid"
                                alt="MacBook Pro">
                            <div class="product-description">
            ...
            <section class="product-section mb-1">
                <div class="row gx-1">
                    <div class="col-md-6">
                        <div class="product-image-container">
                            <img src="{{ asset('assets/img/promo_airpods_4_avail__bl22kvpg6ez6_large.jpg') }}" class="img-fluid"
                                alt="AirPods 4">
                            <div class="product-description">
                    ...
                    <div class="col-md-6">
                        <div class="product-image-container">
                            <img src="{{ asset('assets/img/promo_ipadair_ai__3fv1eitzqv6y_large.jpg') }}" class="img-fluid"
                                alt="iPad Air">
                            <div class="product-description">
                        ...
                        <div id="appleTVCarousel" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{ asset('assets/img/980x551') }} (1).jpg" class="d-block w-100 img-fluid"
                                        alt="Severance">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('assets/img/980x551') }} (2).jpg" class="d-block w-100 img-fluid"
                                        alt="Prime Target">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('assets/img/980x551') }} (3).jpg" class="d-block w-100 img-fluid"
                                        alt="Drama Series">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('assets/img/980x551.jpg') }}" class="d-block w-100 img-fluid"
                                        alt="Latest Apple TV+ Show">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('assets/img/980x551') }} (4).jpg" class="d-block w-100 img-fluid"
                                        alt="Action Series">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('assets/img/980x551') }} (5).jpg" class="d-block w-100 img-fluid"
                                        alt="Sci-Fi Thriller">
                                </div>
                            </div>
