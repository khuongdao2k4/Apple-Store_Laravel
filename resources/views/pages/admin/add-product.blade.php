...
<div class="container" style="padding-top: 100px; max-width: 800px; margin: 0 auto; padding-bottom: 100px;">
    ...
    <div class="card p-5 border-0 shadow-sm" style="border-radius: 20px;">
        <form action="{{ route('store-product') }}" method="POST" class="needs-validation" novalidate id="addProductForm">
            @csrf
            <div class="row g-4">
                <div class="col-12">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="series" id="series_input" list="series_list" class="form-control" placeholder="Ví dụ: iphone-16-pro" style="border-radius: 10px; padding: 12px;" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="series_title" id="series_title_input" class="form-control" placeholder="Ví dụ: iPhone 16 Pro & 16 Pro Max" style="border-radius: 10px; padding: 12px;" required>
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="series_image" id="series_image_input" class="form-control" placeholder="Ví dụ: assets/img/iphone16pro-series.png" style="border-radius: 10px; padding: 12px;" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="price" id="price_input" class="form-control" placeholder="Ví dụ: 25.000.000 VNĐ" style="border-radius: 10px; padding: 12px;" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="quantity" class="form-control" placeholder="100" style="border-radius: 10px; padding: 12px;" required min="0">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="image_url" id="image_url_input" class="form-control" placeholder="Ví dụ: assets/img/iphone16pro.png" style="border-radius: 10px; padding: 12px;" required>
