	...
	<main class="container mt-4 mb-4">
		<section class="jumbotron ">
			...
			<div class="video-container" style="border-radius: 10px">
				<video autoplay muted loop>
					...
					<source src="<?= BASE_URL ?>public/assets/img/large12.mp4" type="video/mp4" />
					...
					<div class="image-carousel">
						<div>
							<div class="image-wrapper">
								<img src="<?= BASE_URL ?>public/assets/img/mac_compatibility__cu59oukz81ci_large.jpg"
						...
						<div>
							<div class="image-wrapper">
								<img src="<?= BASE_URL ?>public/assets/img/mac_durability__epiwcuk7zkeq_large (1).jpg"
						...
						<div>
							<div class="image-wrapper">
								<img src="<?= BASE_URL ?>public/assets/img/mac_intelligence__esfi0qmvis6e_large.jpg"
						...
						<div>
							<div class="image-wrapper">
								<img src="<?= BASE_URL ?>public/assets/img/mac_iphone__gh1tblkt6bqm_large.jpg" style="border-radius: 20px"
									alt="Image 4" />
								<button class="btn btn-dark rounded-circle image-button carousel-button">
									<i class="fas fa-plus"></i>
								</button>
						...
						<div>
							<div class="image-wrapper">
								<img src="<?= BASE_URL ?>public/assets/img/mac_performance__dh5hyac1zf8m_large.jpg"
						...
						<div>
							<div class="image-wrapper">
								<img src="<?= BASE_URL ?>public/assets/img/mac_security__gfwda10khdym_large.jpg"
		...
		<section class="section section-trade-in mt-5">
			...
			<div class="row align-items-center"
				...
				<div class="col-md-6">
					<img src="<?= BASE_URL ?>public/assets/img/tradein__gbtxz5sa3cyi_large.jpg" class="img-fluid" alt="Apple Trade In" />
				</div>
			</div>
		</section>
