    <nav class="navbar navbar-expand-lg fixed-top" style="">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item" ; style="padding: 0px 10px"><a class="nav-link" href="home"><i
                    ...
                    <li class="nav-item" ; style="padding: 0px 10px"><a class="nav-link" href="mac">Mac</a>
                        <div class="submenu-container">
                            <div class="submenu">
                                <ul>
                        ...
                        <div class="submenu-container">
                            <div class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li class="li-row" onclick="location.href='mua-iphone'"
                        ...
                        <div class="submenu-container">
                            <div class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li class="li-row" onclick="location.href='statistics'" >Thống Kê</li>
                                </ul>
                                <ul>
